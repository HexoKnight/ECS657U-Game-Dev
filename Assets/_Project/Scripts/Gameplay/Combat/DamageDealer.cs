...
namespace GUP.Gameplay
{
    ...
    public class DamageDealer : MonoBehaviour
    {
        ...
        private readonly Dictionary<GameObject, float> cooldowns = new();
        ...
        /// </summary>
        /// <param name="center">Center of the damage area.</param>
        ...
        private bool TryDealDamage(GameObject target, Vector3 hitPoint)
        {
            ...
            // Use base damage amount (DDA should be applied at Gameplay layer)
